$(document).ready(function () {
    ...
    $("#checkbox_1").click(function () {
        ...
        if (checked_status == true) {
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'not-allowed');
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'pointer');
    ...
    $("#checkbox_2").click(function () {
        ...
        if (checked_status == true) {
            ...
            $("#checkbox_1, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'not-allowed');
            ...
            $("#checkbox_1, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'pointer');
            $('#subscription_choice').text('Selecteaza un abonament:');
            $("#price_1, #price_2").text('€0.00 / luna');
    ...
    $("#checkbox_3").click(function () {
        ...
        if (checked_status == true) {
            ...
            $("#checkbox_2, #checkbox_1, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'not-allowed');
            ...
            $("#checkbox_2, #checkbox_1, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'pointer');
            $('#subscription_choice').text('Selecteaza un abonament:');
            $("#price_1, #price_2").text('€0.00 / luna');
    ...
    $("#checkbox_4").click(function () {
        ...
        if (checked_status == true) {
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_1, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'not-allowed');
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_1, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'pointer');
            $('#subscription_choice').text('Selecteaza un abonament:');
            $("#price_1, #price_2").text('€0.00 / luna');
    ...
    $("#checkbox_5").click(function () {
        ...
        if (checked_status == true) {
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_1, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'not-allowed');
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_1, #checkbox_6, #checkbox_7, #checkbox_8").css('cursor', 'pointer');
            $('#subscription_choice').text('Selecteaza un abonament:');
            $("#price_1, #price_2").text('€0.00 / luna');
    ...
    $("#checkbox_6").click(function () {
        ...
        if (checked_status == true) {
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_1, #checkbox_7, #checkbox_8").css('cursor', 'not-allowed');
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_1, #checkbox_7, #checkbox_8").css('cursor', 'pointer');
            $('#subscription_choice').text('Selecteaza un abonament:');
            $("#price_1, #price_2").text('€0.00 / luna');
    ...
    $("#checkbox_7").click(function () {
        ...
        if (checked_status == true) {
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_1, #checkbox_8").css('cursor', 'not-allowed');
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_1, #checkbox_8").css('cursor', 'pointer');
            $('#subscription_choice').text('Selecteaza un abonament:');
            $("#price_1, #price_2").text('€0.00 / luna');
    ...
    $("#checkbox_8").click(function () {
        ...
        if (checked_status == true) {
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_1").css('cursor', 'not-allowed');
            ...
            $("#checkbox_2, #checkbox_3, #checkbox_4, #checkbox_5, #checkbox_6, #checkbox_7, #checkbox_1").css('cursor', 'pointer');
            $('#subscription_choice').text('Selecteaza un abonament:');
            $("#price_1, #price_2").text('€0.00 / luna');
